...
namespace UI_Test_TIMESERVICE
{
    internal class MainProcess
    {
        public void MainLogic()
        {
            ...
            employees = CSVHelper.GetEmployees("D:\\DataTimeManagement\\KDC_employee_20221121.csv");
            DatabaseHelper.UpdateEmployee(employees);
            ...
            //        if (!isSuccess)
            //        {
            //            LogHelper.Info("INSERT LOG DATA INTO DATABASE ERROR");
            //            return;
            //        }
            //        transaction.Commit();
